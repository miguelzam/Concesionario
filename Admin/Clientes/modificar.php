...
$sql = "SELECT * FROM clientes
        INNER JOIN estados ON clientes.estado=estados.codestado
        INNER JOIN municipios ON clientes.municipio=municipios.codmunicipio
        INNER JOIN parroquias ON clientes.parroquia=parroquias.codparroquia
...
<head>
  ...
  <title>Consultec | Sistema de COncecionarios</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Modificar de Clientes</li>
      </ol>
    </section>
  ...
  <div class="row">
        ...
        <form name="frm" action="registro/registro_basica.php" method="POST">
              ...
              <div class="col-sm-4 col-md-4">
                <div class="form-group">
                  ...
                  <input data-toggle="tooltip" class="form-control" maxlength="" id="cedulaCliente" name="cedula" placeholder="Cedula de Identidad" readonly="YES" type="text" onblur="this.value=this.value.toUpperCase()"  value="<?php echo $Clientes["cedula"]; ?>" onKeyPress="return valida(event,this,10,8)">
                                            </div>
              </div>
                ...
                <div class="col-sm-4 col-md-4">
                  <div class="form-group">
                    ...
                    <input data-toggle="tooltip" class="form-control" name="nombre" id="nombre" placeholder="Primer Nombre" required="required" type="text" onblur="this.value=this.value.toUpperCase()"value="<?php echo $Clientes["nombre"]; ?>" onKeypress="return valida(event,this,0,25)">
                  </div>
                </div>
                ...
                <div class="col-sm-4 col-md-4">
                  <div class="form-group">
                    <label class="control-label" for="id_middle_name">Segundo Nombre</label>
                      <input class="form-control" name="nombre_2" id="nombre_2" placeholder="Segundo Nombre" data-toggle="tooltip" type="text" onblur="this.value=this.value.toUpperCase()" value="<?php echo $Clientes["nombre_2"]; ?>" onkeypress="return valida(event,this,0,25)">
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input data-toggle="tooltip" class="form-control " name="apellido" id="apellido" placeholder="Primer Apellido" required="required" data-original-title="Indica la información de tu primer apellid type="text" onblur="this.value=this.value.toUpperCase() " value="<?php echo $Clientes["apellido"]; ?>" onkeypress="return valida(event,this,0,25)">
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input data-toggle="tooltip" class="form-control" name="apellido_2" id="apellido_2" placeholder="Segundo Apellido" required="required" type="text" onblur="this.value=this.value.toUpperCase()"value="<?php echo $Clientes["apellido_2"]; ?>" onkeypress="return valida(event,this,0,25)">
                  </div>
                </div>
              </div> <!-- FIN ROW -->
                        ...
                        <?php if ($número_filas=="0") { ?>
                          <option   selected="" value="0">Seleccione...</option>
                            <?php } if ($número_filas=="1") {  ?>
                              <option selected="" value="<?php echo $Clientes['codestado'] ?>"><?php  echo $Clientes["estado"]; ?></option>
                            <?php } ?>
                              <?php  
                      ...
                      <label class="control-label" for="id_country">Municipio</label>
                        <select name="municipio" id="municipio" required="yes" class="form-control">
                          <?php if ($número_filas=="0") { ?>
                            <option  selected="" value="0">Seleccione...</option>
                          <?php } if ($número_filas=="1") {  ?>
                            <option selected="" value="<?php echo $Clientes['codmunicipio'] ?>"><?php  echo $Clientes["municipio"]; ?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                        ...
                        <label class="control-label" for="id_country">Parroquia</label>
                          <select name="parroquia" id="parroquia" required="yes" class="form-control">
                            <?php if ($número_filas=="0") { ?>
                              <option   selected="" value="0">Seleccione...</option>
                            <?php } if ($número_filas=="1") {  ?>
                              <option selected="" value="<?php echo $Clientes['codparroquia']; ?>"><?php  echo $Clientes["parroquia"]; ?></option>
                            <?php } ?>
                          </select>
                       </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3">
                      <div class="form-group">
                        <label class="control-label" for="id_last_name">Ciudad / Localidad</label>
                          <input data-toggle="tooltip" class="form-control" name="ciudad" id="ciudad" placeholder="Ciudad / Localidad" required="required" type="text" onblur="this.value=this.value.toUpperCase()" value="<?php  echo $Clientes["ciudad"]; ?>" onKeyPress="return valida(event,this,0,25)">
                       </div>
                    </div>    
              ...
              <div class="row"> <!-- INICIO ROW -->
                ...
                <div class="form-group">
                  <div class="col-sm-12 col-md-12">
                    ...
                    <input class="form-control" data-toggle="tooltip" id="direccion" name="direccion" placeholder="Dirección" required="required" title="" type="text" value="<?php echo $Clientes["direccion"]; ?>" onblur="this.value=this.value.toUpperCase()" onkeypress="return valida(event,this,23,200)">
                    </div>                           
                  </div>
                </div>
              </div> <!-- FIN ROW -->
              ...
              <div class="row"> <!-- INICIO ROW -->
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" id="id_birth" name="fecha_nac" placeholder="Fecha de Nacimiento" title="" type="text" readonly="yes" value="<?php  echo $Clientes["fecha_nac"]; ?>">
                    </div>
                </div>
              ...
              <div class="row"> <!-- INICIO ROW -->
                ...
                <div class="col-sm-3 col-md-3">
                  <div class="form-group">
                    ...
                    <input data-toggle="tooltip" class="form-control " id="telefono" placeholder="0000-000-00-00" maxlength="35" name="telefono"  type="text" value="<?php echo $Clientes["telefono"]; ?>" onkeyup="mascara(this,'-',patron2,true)" onkeypress="return valida(event,this,10,14)">
                  </div>
                </div> 
                ...
                <div class="col-sm-3 col-md-3">
                  <div class="form-group">
                    ...
                    <input data-toggle="tooltip" class="form-control " name="celular" id="celular" placeholder="0000-000-00-00" required="yes" type="text" value="<?php echo $Clientes["celular"]; ?>" onkeyup="mascara(this,'-',patron2,true)" onkeypress="return valida(event,this,10,14)">
                  </div>
                </div> 
              ...
              <div class="row"> <!-- INICIO ROW -->
                <div class="col-sm-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input data-toggle="tooltip" class="form-control " name="correo" id="correo" placeholder="Correo electrónico principal" required="yes"  type="email" value="<?php echo $Clientes["correo"]; ?>" onblur="this.value=this.value.toUpperCase()" onkeypress="return valida(event,this,5,50)">
                  </div>
                </div>
                ...
                <div class="col-sm-3 col-md-3">
                  <div class="form-group">
                    <label class="control-label" for="id_country">Concesionario</label>
                      <select name="" id="concecionario" class="form-control" required="yes">
                        <?php if ($número_filas=="0") { ?>
                          <option   selected="" value="0">Seleccione...</option>
                            <?php } if ($número_filas=="1") {  ?>
                              <option selected="" value="<?php echo $Clientes['concecionario'] ?>"><?php  echo $Clientes["nombre_concecionario"]; ?></option>
                            <?php } ?>
                              <?php  
                              //Aqui me conecto a la base de datos y ejecuto una consulta SQL para traer todos los paises;
    ...
    <div class="row"> <!-- INICIO ROW --> 
      <div class="col-sm-3 col-md-3 col-md-offset-10">
        <button onclick="ActualizarDatosClientes();" type="button" class="btn btn-primary">Actualizar</button>
      </div>
    </div>
...
<script>
  ...
  if (cedulaCliente == '') {
    ...
    swalAlert("¡ Advertencia !","Por favor complete el campo (Fecha de Nacimiento).","warning")
  ...
  } else if (concecionarioCliente == '0') {
    swalAlert("¡ Advertencia !","Por favor complete el campo (Concecionario).","warning")               
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {
                  action: 'ActualizarDatosClientes',
        ...
        if (!respuesta.error) {
          ...
          if (respuesta.tipo == '1') {
              ...
              document.location.href = 'listarClientes.php'
          }
