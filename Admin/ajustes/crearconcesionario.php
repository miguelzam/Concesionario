  ...
  <div class="row">
      ...
      <div class="form-group">
        ...
        <form name="frm" action="registro/registro_basica.php" method="POST">
              ...
              <div class="col-sm-4 col-md-4">
                ...
                <div class="form-group">
                  <label class="control-label" for="id_first_name">Concesionario</label>
                  <input data-toggle="tooltip" class="form-control" maxlength="" id="concesionario" name="cedula" placeholder="Usuario" required="yes" type="text" onblur="this.value=this.value.toUpperCase()"  value="" onKeyPress="return valida(event,this,0,50)">
                </div>
    ...
    <div class="row"> <!-- INICIO ROW --> 
      <div class="col-sm-3 col-md-3 col-md-offset-10">
        <button onclick="GuardarConcesionario();" type="button" class="btn btn-primary">Guardar</button>
...
<script>
  ...
  if (concesionario == '') {
    swalAlert("¡ Advertencia !","Por favor complete el campo (Nombre del Concesionario).","warning")
